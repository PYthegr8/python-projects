...
def plot_SIR( S_list , I_list , R_list , S0 , I0 , R0 ):
	...
	#extension: Allows User to specify the name of the disease plot
	plotname = input("Enter the name of your disease:")
	plt.title( plotname+'  ' + 'SIR simulation for S0: ' + str( S0 ) + ", I0: " + str( I0 ) + ", R0: " + str( R0 ), )
	plt.xlabel( '# Days' )
	plt.ylabel( '# people' )
...
def compute_new_susceptible(num_spreading_contacts, S0, I0, population_size):
	'''This function computes the total number of susceptible people on day 1 '''
...
def compute_new_infected( num_spreading_contacts, recovery_time, S0, I0 , population_size ):
	'''This function  computes the total number of newly infected people on day 1 '''
...
def compute_new_recovered( recovery_time , R0 , I0 ):
	'''This function  computes the total number of  newly recovered people on day 1 '''
...
num_spreading_contacts= float(input('Enter the number of spreading contacts for this simulation: '))
recovery_time= float(input('Enter the recovery time for this simulation: '))
